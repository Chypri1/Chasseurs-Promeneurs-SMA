...
; Sheep are both breeds of turtles
...
to setup
  ...
  ask patches [
    set pcolor green
    set countdown random 50  ; initialise le temps de repousse de l'herbe
  ]
  ...
  create-sheep initial-number-sheep [
    ...
    set energy random 20  ; énergie initiale des moutons fixée entre 0 et 20
